...
<body>
  <div class=e79_247>
    ...
    <div class="typo">
      <div class="header">
        <textarea name="title" id="header" cols="30" rows="1" placeholder="Type the header..."></textarea>
      </div>
      <textarea name="description" id="" cols="30" rows="10" placeholder="Type content..."></textarea>
