...
<head>
  ...
  <link rel="stylesheet" href="sample_1.css">
...
<body>
  <div class=e79_247>
    ...
    <div class="typo">
      <div class="header">
        <textarea name="header" id="header" cols="30" rows="1" placeholder="Type the header...">Weekly playlist
        </textarea>
      </div>
      <textarea name="" id="" cols="30" rows="10" placeholder="Type content...">"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</textarea>
